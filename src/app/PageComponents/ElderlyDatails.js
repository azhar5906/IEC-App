...
export default function ElderlyDatails() { 
  ...
  return (
  <>
    <VStack padding={"20px"} height={887} width={852} bgColor={"#F3F3F3"} justifyContent={'flex-start'} alignItems={'start'}   >
        <Flex height="76px" direction="column" justifyContent="space-between" >   
       ...
       {ElderlyDatails.map((data, index)=>( 
          ...
          <VStack 
          key={index} width="812px" height="124px"  padding="16px" bgColor=" #FFFFFF;" >
        ...
        <Button  marginTop="339px" height="40px" width="812px"border="1px solid #0A84FF" borderRadius="4px"  color="#0A84FF" alignSelf="end">
